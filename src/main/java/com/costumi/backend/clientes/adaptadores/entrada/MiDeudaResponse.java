 ...
 */
public record MiDeudaResponse(UUID empresaId, UUID sucursalId, String empresaNombre, UUID rentaId,
		String codigoRetiro, String estado, LocalDate fechaRetiro, LocalDate fechaDevolucion, BigDecimal importe,
	...
	static MiDeudaResponse desde(DeudaEnTienda d) {
		var l = d.linea();
		return new MiDeudaResponse(d.empresaId(), d.sucursalId(), d.empresaNombre(), l.rentaId(), l.codigoRetiro(),
				l.estado(), l.fechaRetiro(), l.fechaDevolucion(), l.importe(), l.cargoPorDanos(), l.cargoPorRetraso(),
