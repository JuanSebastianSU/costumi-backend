...
class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				// Headers de seguridad (C4). nosniff y X-Frame-Options: DENY ya van por defecto en Spring Security.
				...
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(HttpMethod.PATCH, "/api/v1/empresas/*/sucursales/*").hasAnyRole("DUENO", "ENCARGADO")
						...
						.requestMatchers(HttpMethod.PUT, "/api/v1/empleados/*/rol").hasAnyRole("DUENO", "ENCARGADO")
						...
						.requestMatchers(HttpMethod.PATCH, "/api/v1/categorias/*").hasAnyRole("DUENO", "ENCARGADO")
						.requestMatchers(HttpMethod.POST, "/api/v1/categorias/*/archivar",
								"/api/v1/categorias/*/activar").hasAnyRole("DUENO", "ENCARGADO")
						...
						.requestMatchers(HttpMethod.POST, "/api/v1/tipos-etiqueta/*/archivar",
								"/api/v1/tipos-etiqueta/*/activar", "/api/v1/tipos-etiqueta/*/valores/*/archivar",
								"/api/v1/tipos-etiqueta/*/valores/*/activar").hasAnyRole("DUENO", "ENCARGADO")
						.requestMatchers(HttpMethod.PATCH, "/api/v1/tipos-etiqueta/**").hasAnyRole("DUENO", "ENCARGADO")
						.requestMatchers(HttpMethod.GET, "/api/v1/categorias/*/prendas/conteo",
								"/api/v1/tipos-etiqueta/*/prendas/conteo",
								"/api/v1/tipos-etiqueta/*/valores/*/prendas/conteo").hasAnyRole("DUENO", "ENCARGADO")
						.requestMatchers(HttpMethod.POST, "/api/v1/prendas").hasAnyRole("DUENO", "ENCARGADO", "BODEGA")
						.requestMatchers(HttpMethod.PUT, "/api/v1/prendas/*").hasAnyRole("DUENO", "ENCARGADO", "BODEGA")
						.requestMatchers(HttpMethod.POST, "/api/v1/prendas/*/archivar",
								"/api/v1/prendas/*/activar").hasAnyRole("DUENO", "ENCARGADO", "BODEGA")
						...
						.requestMatchers(HttpMethod.POST, "/api/v1/pagos/intento/cliente").hasRole("CLIENTE")
						...
						.requestMatchers(HttpMethod.POST, "/api/v1/notificaciones/probar-push/*").hasAnyRole("DUENO", "ENCARGADO")
