...
/** Cola de empresas PENDIENTES con marca de vencida (RF-15.4), extremo a extremo. */
@SpringBootTest
...
class ConsultarEmpresasPendientesIntegrationTest {
	...
	@Test
	void la_cola_incluye_una_recien_registrada_y_no_vencida() throws Exception {
		...
		String body = mvc.perform(get("/api/v1/empresas/pendientes"))
